    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-slate-600">
            <template v-if="! recovery">
                Confirme o acesso à sua conta informando o código de autenticação gerado pelo seu aplicativo autenticador.
            </template>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <button type="button" class="text-sm text-emerald-600 hover:text-emerald-800 underline cursor-pointer" @click.prevent="toggleRecovery">
                    <template v-if="! recovery">
