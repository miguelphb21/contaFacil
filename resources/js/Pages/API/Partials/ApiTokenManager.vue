    ...
    <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="flex items-center">
                                ...
                                <span class="ms-2 text-sm text-slate-600">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                            ...
                            <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                                ...
                                <div class="flex items-center ms-2">
                                    ...
                                    <button
                                        ...
                                        class="cursor-pointer ms-6 text-sm text-slate-400 underline"
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-slate-100 px-4 py-2 rounded font-mono text-sm text-slate-500 break-all">
