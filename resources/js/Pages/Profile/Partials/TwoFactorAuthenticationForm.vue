...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-slate-900">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-slate-900">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-medium text-slate-900">
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-slate-600">
